...
# SPECIFICATION: Use Keras to load the dataset of fashion items for training and test multiple deep 
# neural networks and check their corresponding performances, then update the highest accuracy found.
