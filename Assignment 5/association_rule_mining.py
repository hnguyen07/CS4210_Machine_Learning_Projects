...
# SPECIFICATION: A program that finds strong rules related to supermarket products.
...
for index, rule in rules.iterrows():
    print(*rule['antecedents'], sep=', ', end=' -> ')
    print(*rule['consequents'], sep=', ')
    print('Support: ' + str(rule['support']))
    print('Confidence: ' + str(rule['confidence']))

#To calculate the prior and gain in confidence, find in how many transactions the consequent of the rule appears (the supportCount below). Then,
