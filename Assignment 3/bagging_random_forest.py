...
# SPECIFICATION: build a base classifier by using a single decision tree, an ensemble classifier that combines multiple decision trees,
# and a Random Forest classifier to recognize those digits; then test the accuracy of those distinct models.
